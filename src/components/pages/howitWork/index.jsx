        ...
        <div className="container">
          <div className="work-heading">
            ...
            <p className="description">
              Add your business to Gilgal, so customers can easily find
            </p>
          </div>
          <div className="row">
            ...
            <div className="col-lg-4 col-md-4 d-flex">
              <div className="work-info card">
                ...
                <img src={work2_jpg} className="img-fluid" alt="" />
              </div>
            </div>
            <div className="col-lg-4 col-md-4 d-flex">
              <div className="work-info card">
                <img src={work3_jpg} className="img-fluid" alt="" />
                <h5>03</h5>
        ...
        <div className="section-heading">
          <div className="container">
            <div className="row text-center">
              ...
              <p>
                You can set to charge users for Packages, Subscriptions, Hybrid
                or Free
              </p>
            </div>
          </div>
