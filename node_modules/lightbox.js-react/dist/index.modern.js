...
var SlideshowLightbox = forwardRef(function (props, ref) {
  ...
  var _useState22 = useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState22[0],
    setIsRounded = _useState22[1];
  var _useState23 = useState(props.showControls ? props.showControls : true),
    showControls = _useState23[0],
    setShowControls = _useState23[1];
  var _useState24 = useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState24[0],
    setDisplayFullScreenIcon = _useState24[1];
  var _useState25 = useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState25[0],
    setDisplayThumbnailIcon = _useState25[1];
  var _useState26 = useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState26[1];
  var _useState27 = useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState27[0],
    setDisplayMagnificationIcons = _useState27[1];
  var _useState28 = useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState28[0];
  var _useState29 = useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState29[0];
  var _useState30 = useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState30[0];
  var _useState31 = useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState31[0];
  var _useState32 = useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState32[0];
  var _useState33 = useState(props.showNavigationDots ? props.showNavigationDots : false),
    navigationDots = _useState33[0];
  var _useState34 = useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState34[0];
  var _useState35 = useState(props.rtl ? props.rtl : false),
    isRTL = _useState35[0];
  var _useState36 = useState(props.framework ? props.framework : ''),
    frameworkID = _useState36[0];
  var _useState37 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState37[0];
  var _useState38 = useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState38[0];
  var _useState39 = useState(props.licenseKey ? props.licenseKey : '');
  var _useState40 = useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState40[0],
    setDisplayLoader = _useState40[1];
  var _useState41 = useState(props.controlComponent ? props.controlComponent : false),
    customControlComponent = _useState41[0];
  var _useState42 = useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
  ...
  var _useState47 = useState(props.displayMetadata ? props.displayMetadata : false),
  ...
  var _useState50 = useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState50[0],
    setShowThumbnails = _useState50[1];
  var _useState51 = useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState51[0];
  var _useState52 = useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState52[1];
  var _useState53 = useState(props.arrowStyle ? props.arrowStyle : 'dark'),
  ...
  var _useState64 = useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
...
var AnimImage = function AnimImage(props) {
  ...
  var _useState18 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
