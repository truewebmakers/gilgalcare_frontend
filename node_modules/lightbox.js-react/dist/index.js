...
var SlideshowLightbox = React.forwardRef(function (props, ref) {
  ...
  var _useState22 = React.useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState22[0],
    setIsRounded = _useState22[1];
  var _useState23 = React.useState(props.showControls ? props.showControls : true),
    showControls = _useState23[0],
    setShowControls = _useState23[1];
  var _useState24 = React.useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState24[0],
    setDisplayFullScreenIcon = _useState24[1];
  var _useState25 = React.useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState25[0],
    setDisplayThumbnailIcon = _useState25[1];
  var _useState26 = React.useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState26[1];
  var _useState27 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState27[0],
    setDisplayMagnificationIcons = _useState27[1];
  var _useState28 = React.useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState28[0];
  var _useState29 = React.useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState29[0];
  var _useState30 = React.useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState30[0];
  var _useState31 = React.useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState31[0];
  var _useState32 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState32[0];
  var _useState33 = React.useState(props.showNavigationDots ? props.showNavigationDots : false),
    navigationDots = _useState33[0];
  var _useState34 = React.useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState34[0];
  var _useState35 = React.useState(props.rtl ? props.rtl : false),
    isRTL = _useState35[0];
  var _useState36 = React.useState(props.framework ? props.framework : ''),
    frameworkID = _useState36[0];
  var _useState37 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState37[0];
  var _useState38 = React.useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState38[0];
  var _useState39 = React.useState(props.licenseKey ? props.licenseKey : '');
  var _useState40 = React.useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState40[0],
    setDisplayLoader = _useState40[1];
  var _useState41 = React.useState(props.controlComponent ? props.controlComponent : false),
    customControlComponent = _useState41[0];
  var _useState42 = React.useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState42[1];
  ...
  var _useState47 = React.useState(props.displayMetadata ? props.displayMetadata : false),
    displayImgMetadata = _useState47[0];
  var _useState48 = React.useState(false),
    showImgMetadataPanel = _useState48[0],
    setShowImgMetadataPanel = _useState48[1];
  var _useState49 = React.useState({}),
    imgMetadata = _useState49[0],
    setImgMetadata = _useState49[1];
  var _useState50 = React.useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState50[0],
    setShowThumbnails = _useState50[1];
  var _useState51 = React.useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState51[0];
  var _useState52 = React.useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState52[1];
  var _useState53 = React.useState(props.arrowStyle ? props.arrowStyle : 'dark'),
    arrowStyle = _useState53[0];
  var _useState54 = React.useState(false),
    setYTVideoCurrentlyPlaying = _useState54[1];
  var _useState55 = React.useState(false),
    isBrowserFullScreen = _useState55[0],
    setIsBrowserFullScreen = _useState55[1];
  var _useState56 = React.useState(false),
    enableMagnifyingGlass = _useState56[0],
    setMagnifyingGlass = _useState56[1];
  var _useState57 = React.useState(false),
    imagesLoaded = _useState57[0],
    setImagesLoaded = _useState57[1];
  var imageRef = React.useRef(null);
  var _useState58 = React.useState(0),
    zoomIdx = _useState58[0],
    setZoomIdx = _useState58[1];
  var _useState59 = React.useState(500),
    imgContainHeight = _useState59[0],
    setImgContainHeight = _useState59[1];
  var _useState60 = React.useState(426),
    imgContainWidth = _useState60[0],
    setImgContainWidth = _useState60[1];
  var _useState61 = React.useState(false),
    isInit = _useState61[0],
    setIsInit = _useState61[1];
  var open = props.open;
  ...
  var _useState62 = React.useState({}),
    videoElements = _useState62[0],
    setVideoElements = _useState62[1];
  var _useState63 = React.useState(true),
    isLoading = _useState63[0],
    setIsLoading = _useState63[1];
  ...
  var _useState64 = React.useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState64[0];
  ...
  var regularImgPaneNodes = Array.apply(null, Array(images.length)).map(function (_, index) {
    return React.createElement("div", {
      ...
      className: "" + (displayImgMetadata ? styles.embla__slide_grid : styles.embla__slide)
...
var AnimImage = function AnimImage(props) {
  ...
  var _useState18 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
